...
class _$Multiline<T> extends Multiline<T> {
  const _$Multiline({required this.failedValue}) : super._();
...
abstract class Multiline<T> extends ValueFailure<T> {
  const factory Multiline({required T failedValue}) = _$Multiline<T>;
  const Multiline._() : super._();
...
class _$ListTooLong<T> extends ListTooLong<T> {
...
abstract class ListTooLong<T> extends ValueFailure<T> {
  const factory ListTooLong({required T failedValue, required int max}) =
      _$ListTooLong<T>;
  const ListTooLong._() : super._();
...
class _$ShortPassword<T> extends ShortPassword<T> {
  const _$ShortPassword({required this.failedValue}) : super._();
