...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    NoteOverviewRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return const _i5.NoteOverviewPage();
        }),
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(NoteOverviewRoute.name, path: '/note-overview-page'),
...
class NoteOverviewRoute extends _i1.PageRouteInfo {
  const NoteOverviewRoute() : super(name, path: '/note-overview-page');
